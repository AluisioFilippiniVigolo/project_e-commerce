...
if($total_data > 0)
{
  foreach($produtos as $row)
  {
    ...
    <tr>
      ...
      <td>
        <a href="mostra_produto.php?codigo=' .$row['procod']. '" class="btn btn-primary left-margin">
        <span class="glyphicon glyphicon-list"></span> Mostrar
        </a>
        <a href="modifica_produto.php?codigo=' .$row['procod']. '" class="btn btn-info left-margin">
        <span class="glyphicon glyphicon-edit"></span> Editar
        </a>
        <a href="remove_produto.php?codigo=' .$row['procod']. '" class="btn btn-danger left-margin" onclick=\"return confirm("Tem certeza que quer excluir?")\">
